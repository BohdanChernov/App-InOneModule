...
<#list products as product>
    <div class="row justify-content-center" id="basketRow">
        <span class="col-12 col-sm-6 col-md-6 col-lg-4 align-self-center"><img id="imageLaptopBasket" src="${product.getPhoto()[0].getLocation()}"></span>
        <span class="col-12 col-sm-6 col-md-6 col-lg-2 align-self-center">${product.getLaptopManufacturer().getValue()}</span>
        <span class="col-12 col-sm-6 col-md-6 col-lg-3 align-self-center">${product.getModel()}</span>
        <span class="col-12 col-sm-3 col-md-3 col-lg-1 align-self-center">${product.getPrice()} UAH</span>
        <span class="col-12 col-sm-3 col-md-3 col-lg-2 align-self-center"><button class="btn btn-danger deleteFromBasket" value="${product.getId()}">Удалить</button></span>
    </div>
</#list>
